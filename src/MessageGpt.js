        ...
        <div className="sliding-component">
            <div className="content">
                <h2>Please fill in the gaps in the prompt below.
                    ...
                    <button onClick={toggleOverlay} tabIndex={0} onKeyDown={(event) => handleKeyDown(event)} className='x'>&#x2715;</button>
                    <textarea
                ...
                <div className="result">
                    <p>{response}</p>
                    {response && (
                        <button onClick={handleCopyResult} className='copy'>Copy Result</button>
                    )}
                </div>
            </div>
        </div>
